...
## How to Install
Note: This software is only compatiable with Windows OS. If you are using another OS, you can use the University's virtual machines or lab computers that run Windows to use this software.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzE1OTU4MTAxLDEyNDk3NTQ4NzEsNzI4Nz
IzMDU0XX0=
-->